(function () {
  ...
  const i18n = {
    en: {
      ...
      arcturus_meta: 'Juan Collada and Ruben Megido · SAA Omega · Spectroscopy · FAAE Spring Asterisms Competition · April 2026 · PDF in Spanish',
      ...
      simple_arcturus_desc: 'Article featuring a SIMPLE case study applied to the reduction, calibration, normalization and analysis of the Arcturus spectrum. PDF in Spanish.',
      sec_contact: 'Contact',
      download_tooltip: 'Download in early 2027',
      ...
      news_release_march: 'SIMPLE will be released in early 2027 in its 1.0-beta1 version. It is an application under continuous development until the release of the final 1.0 version.',
