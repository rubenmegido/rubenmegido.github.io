(function () {
  ...
  const i18n = {
    en: {
      ...
      sec_contact: 'Contact',
      download_tooltip: 'Download during May 2026',
      ...
      news_release_march: 'SIMPLE will be released during May 2026 in its 1.0-beta1 version. It is an application under continuous development until the release of the final 1.0 version.',
